            ...
            <ul class="navbar-nav ms-auto align-items-center">
                ...
                @auth
                    ...
                    <li class="nav-item dropdown ms-2">
                        <button
                            class="nav-link dropdown-toggle d-flex align-items-center profile-dropdown btn btn-link"
                            type="button"
                ...
                @else
                    <li class="nav-item">
                        <a class="nav-link nav-link-bloom" href="{{ route('about') }}">
                            About
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="btn btn-outline-bloom ms-2" href="{{ route('login') }}">
                            Login
                        </a>
                    </li>
                @endauth
